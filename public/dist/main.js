...
/***/ function(module, exports, __webpack_require__) {
	...
	Router.run(routes, Router.HashLocation, function(Root) {
	    React.render(React.createElement(NavBar, null), document.getElementById('js-navbar'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	const $ = __webpack_require__(197);

	/**
	 * items of dropdown list
	 */
	let DropdownItem = React.createClass({displayName: "DropdownItem",
	 ...
	 * items of navigation
	 */
	let NavItem = React.createClass({displayName: "NavItem",
	    ...
	    render: function() {
	        ...
	        if (navItem.dropdown) {
	            navItemDom = (
	                React.createElement("li", {onMouseEnter: this.showDropdown, onMouseOut: this.hideDropdown}, 
	                    React.createElement("a", {href: navItem.href}, navItem.name), 
	                    React.createElement("div", {className: "dropdown-list hidden"}, 
	                        React.createElement("ul", {className: "list-unstyled"}, 
	                            
	                                navItem.dropdown.map(function(dropdownItem) {
	                                    return React.createElement(DropdownItem, {dropdownItem: dropdownItem})
	                                })
	        ...
	        return (
	            React.createElement("div", {className: "collapse navbar-collapse"}, 
	                React.createElement("ul", {className: "nav navbar-nav"}, 
	                        ...
	                        this._navs.map(function(_nav) {
	                            return React.createElement(NavItem, {navItem: _nav})
	                        })
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    render: function() {
	        return (
	            React.createElement("div", {className: "thumbnail"}, 
	                React.createElement("img", {src: this.props.goods.picUrl}), 
	...
	const GoodsList = React.createClass({displayName: "GoodsList",
